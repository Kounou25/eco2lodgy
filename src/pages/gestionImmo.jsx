            ...
            {achievements.map((achievement, index) => (
              ...
              >
                <motion.div
                  ...
                  whileHover={{ scale: 1.2, rotate: 5, transition: { duration: 0.3, ease: 'easeInOut' } }}
                >
                  {achievement.icon}
                </motion.div>
                <motion.div
      ...
      >
        <div className="container mx-auto px-6">
          <motion.div className="text-center mb-12" variants={fadeIn}>
            ...
            <h2 className="text-4xl font-bold text-[#556331] mt-4 mb-6">
              Découvrez nos <span className="text-[#be9838]">propriétés</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Une sélection de propriétés que nous promouvons et gérons, mettant en avant leur potentiel et leur valeur.
            </p>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {galleryImages.map((image, index) => (
              ...
              >
                ...
                />
                <motion.div
                  className="absolute inset-0 bg-gradient-to-t from-[#556331]/80 to-transparent flex items-end"
                  initial={{ opacity: 0, y: 20 }}
                  whileHover={{ opacity: 1, y: 0, transition: { duration: 0.3, ease: 'easeInOut' } }}
                >
                  <p className="text-white text-sm font-semibold p-4">{image.caption}</p>
                </motion.div>
              </motion.div>
            ))}
          </div>
