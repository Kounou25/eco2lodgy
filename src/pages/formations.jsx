  ...
  const projects = [
    {
      ...
      tags: ["Vulgarisation", "Communauté", "Sensibilisation"]
    },
    {
      title: "Formation des Artisans",
      description: "Programmes pratiques pour enseigner des techniques constructives durables.",
      image: "https://images.unsplash.com/photo-1503428593587-cb022f85b08f?q=80&w=2070&auto=format&fit=crop",
      tags: ["Formation", "Artisans", "Techniques"]
    },
  ];
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 overflow-hidden" ref={ref}>
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          >
            Former pour <br className="md:hidden"/> <span className="text-[#be9838]">innover</span>
          </motion.h1>
          ...
          >
            <motion.div className="text-center mb-20" variants={fadeIn}>
              ...
              <motion.h3 
                ...
                variants={fadeIn}
              >
                Programmes <span className="text-[#be9838]">phares</span>
              </motion.h3>
              <motion.p 
                className="text-gray-600 max-w-2xl mx-auto text-lg"
                variants={fadeIn}
              >
                Des formations pratiques pour un impact durable dans les communautés
              </motion.p>
            </motion.div>
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 p-8 w-full">
                    ...
                    <button className="flex items-center text-white group-hover:text-[#be9838] transition-colors">
                      <span className="mr-3 font-medium">Découvrir le programme</span>
          ...
          >
            <motion.div className="text-center mb-20" variants={fadeIn}>
              ...
              <motion.h3 
                ...
                variants={fadeIn}
              >
                Rencontrez nos <span className="text-[#be9838]">formateurs</span>
              </motion.h3>
            </motion.div>
          ...
          >
            ...
            <div className="relative z-10 py-20 px-8 md:px-16 text-center">
              <motion.h3 
                ...
                variants={fadeIn}
              >
                Prêt à <span className="text-[#be9838]">apprendre</span> <br className="hidden md:block" />et innover ?
              </motion.h3>
              <motion.p 
