            ...
            <form className="mb-6">
              <div className="flex">
                <input 
                  ...
                  className="w-full px-4 py-3 rounded-l-lg text-gray-800 bg-white outline-none"
                />
                <Button className="bg-[#D4A017] hover:bg-gray-200 hover:text-[#2E5A27] rounded-l-none transition-colors">
