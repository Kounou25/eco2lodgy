...
const Footer = () => {
  ...
  return (
    <footer className="bg-eco-green/95 text-white">
      <div className="container mx-auto px-4 py-16">
          ...
          <div>
            ...
            <form className="mb-6">
              <div className="flex">
                ...
                />
                <Button className="bg-eco-light hover:bg-white hover:text-eco-green rounded-l-none transition-colors">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white/80">+33 01 23 45 67 89</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-start space-x-3">
                ...
                <span className="text-white/80">123 Avenue de l'Innovation, 75001 Paris, France</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-white/70 mb-4 md:mb-0">
            &copy; {currentYear} Eco2lodgy. Tous droits réservés.
          </div>
          <div className="flex space-x-6">
            <a href="#" className="text-white/70 hover:text-white transition-colors">Politique de confidentialité</a>
            <a href="#" className="text-white/70 hover:text-white transition-colors">Conditions d'utilisation</a>
