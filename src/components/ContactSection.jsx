          ...
          <div>
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-eco-green/10 hover:bg-eco-green flex items-center justify-center text-eco-green hover:text-white transition-colors">
